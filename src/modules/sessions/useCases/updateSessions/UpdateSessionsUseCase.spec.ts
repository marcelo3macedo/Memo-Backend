...
let updateSessionsUseCase: UpdateSessionsUseCase;
...
describe("List Sessions", () => {
    beforeEach(() => {
        ...
        updateSessionsUseCase = new UpdateSessionsUseCase(sessionsRepositoryInMemory, null, cardsRepositoryInMemory);
